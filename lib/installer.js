...
function queryLatestMatch(versionSpec) {
    return __awaiter(this, void 0, void 0, function* () {
        let versions = [];
        let rest = new restm.RestClient('setup-sentinel');
        let release = (yield rest.get('https://releases.hashicorp.com/sentinel/index.json')).result;
